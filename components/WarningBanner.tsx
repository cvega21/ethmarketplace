...
const WarningBanner = () => {
  ...
  return (
      <div className="w-10/12 border px-4 border-black shadow-xl bg-yellow-300 rounded-xl flex items-center text-black justify-center top-2 transition-all text-sm lg:text-lg mt-8 py-2">
