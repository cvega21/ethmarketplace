  ...
  return (
    <Link href={`/products/${props.refString}`} passHref>
      <a href={`/products/${props.refString}`}>
        <div className="flex flex-col border rounded-xl lg:my-0 transform hover:shadow-xl hover:-translate-y-2 transition-all text-white bg-gray-800 hover:cursor-pointer w-full md:w-full">
